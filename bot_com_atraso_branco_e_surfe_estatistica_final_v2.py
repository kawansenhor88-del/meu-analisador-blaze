...
def _montar_linhas_estrategia_surfe(registros, estrategia):
    ...
    for item in registros:
        ...
        linhas.append(f"{_numero_emoji(item['numero'])} {linha_resultado}")
...
def analisar_surfe_a_partir_do_branco(indice_branco, limite=None):
    ...
    # O Branco escolhido é o gatilho. O SURF começa pela rodada mais recente
    # encontrada antes desse Branco e segue nessa direção (ex.: 11 -> 14 -> ...).
