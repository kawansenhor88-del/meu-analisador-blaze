...
def _montar_surfe_duas_colunas(registros, numero_final_analise=None):
    ...
    for esquerda, direita in zip(vermelho, preto):
        ...
        # Mantém o espaçamento ORIGINAL entre as duas colunas também em 1000+.
        # A correção matemática das faixas 00–07 (1000–1007, 1100–1107...)
        # já é aplicada individualmente dentro de _montar_linhas_estrategia_surfe().
        # Não deslocamos a coluna direita inteira.
