...
def painel_callback(call):
    try:
        ...
        if call.data == "branco_atraso":
            ...
            # Divide somente entre linhas, evitando cortar datas, horários
            # ou detalhes de um intervalo no meio da mensagem.
            for parte in dividir_texto_telegram(resultado):
