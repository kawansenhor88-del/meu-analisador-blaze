...
def controle_geral_surfe_entender_callback(call):
    try:
        ...
        texto = "\n".join([
            ...
            "",
            "📊 O Controle Geral testa essa estratégia partindo de qualquer posição possível das 2.000 rodadas disponíveis mais recentes.",
            "",
            "🔥 G1, G2, G3... mostram o nível de Gale usado para agrupar os caminhos encontrados nesta análise.",
            "",
            "📍 Cada ocorrência continua ligada ao ponto de início original: cor, número, data, horário e rodada.",
            "",
            "👇 Ao escolher um Gale, você pode localizar exatamente os pontos de início registrados naquele grupo e depois abrir o SURF correspondente.",
        ])
        markup = telebot.types.InlineKeyboardMarkup(row_width=1)
        markup.add(telebot.types.InlineKeyboardButton(
