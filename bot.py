...
def _montar_linhas_estrategia_surfe(registros, estrategia, numero_final_analise=None):
    ...
    for item in registros:
        ...
        if 1 <= numero <= 8:
            ...
            # Faixa específica 1000–1007:
            # mantém a coluna esquerda como já estava; a coluna direita será
            # aproximada 0.2 para a esquerda no separador entre as colunas.
            valor_config = (
            ...
            valor_config = 0.4 if estrategia == "Vermelho" else 0.0
