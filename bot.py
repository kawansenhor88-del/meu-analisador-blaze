...
def _controle_geral_surfe_enviar_sequencias(chat_id, caminho_nome):
    ...
    # Calcula pelo TOTAL DE DÍGITOS, ignorando ponto de milhar.
    # Exemplo: 1.142 = 4 dígitos, 624 = 3, 97 = 2, 5 = 1.
    ...
    for gale in gales:
        ...
        # Número começa imediatamente após o emoji.
        # A quantidade de espaços depois dele é:
        # maior quantidade de dígitos - quantidade de dígitos do número atual.
        unico = unico_str + (" " * (maior_digitos_unico - digitos_unico))
        bruto = bruto_str + (" " * (maior_digitos_bruto - digitos_bruto))
