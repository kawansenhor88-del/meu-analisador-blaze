...
def analisar_surfe():
    ...
    linhas = [
        ...
        "",
        f"⚪ BRANCO → {hora_branco}                 ⚪ BRANCO → {hora_branco}",
        "",
    ]
    ...
    introducao = "\n".join([
        ...
        "",
        "📚 Caminho exibido: 100 rodadas",
        "📊 Cálculo geral: 2.000 rodadas",
        "",
        "⚪ PRIMEIRO BRANCO MAIS RECENTE",
        f"📅 Data: {data_branco}",
        f"🕐 Horário: {hora_branco}",
        "",
        "A partir deste Branco começa o SURFE.",
        "",
        "⚫ 2 PRETOS → 2 VERMELHOS → 2 PRETOS...",
        "🔴 2 VERMELHOS → 2 PRETOS → 2 VERMELHOS...",
        "",
        "✅ Cor igual: ACERTO",
        "❌ Cor diferente: GALE 1, GALE 2, GALE 3... até acertar.",
        "⚪ Os Brancos seguintes não reiniciam o caminho.",
        "",
        "👇 Clique abaixo para visualizar o caminho:",
    ])
...
def surfe_callback(call):
    try:
        ...
        for parte in mensagens:
            m = bot.send_message(chat_id, parte)
