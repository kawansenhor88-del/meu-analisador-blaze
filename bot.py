...
def receber_webhook():
    try:
        ...
        # Captura temporária do ID do canal de alertas.
        # Depois do deploy, envie uma NOVA mensagem no canal e confira o log do Render.
        # Isso não altera nenhuma estratégia nem interfere no processamento normal do bot.
        try:
            ...
            if post:
                ...
                print("========================================")
                print("CHANNEL_POST RECEBIDO")
                print("CHAT_ID:", chat_canal.get("id"))
                print("TITULO:", chat_canal.get("title"))
                print("TEXTO:", post.get("text", ""))
                print("========================================")
        except Exception as erro_canal:
            print("ERRO AO CAPTURAR ID DO CANAL:", str(erro_canal))
