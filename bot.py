...
def _montar_linhas_estrategia_surfe(registros, estrategia):
    ...
    for item in registros:
        ...
        espacos_numero_rodada = "   " if numero < 10 else ""
...
def _montar_surfe_duas_colunas(registros):
    """Monta os dois SURF lado a lado, de forma compacta."""
    ...
    for esquerda, direita in zip(vermelho, preto):
        # O espaçamento entre as duas colunas é definido SOMENTE pelo primeiro SURF (esquerda).
        # ❌ G1/G2/... = 5 espaços; ✅ = 12 espaços.
        # No segundo SURF (direita), não acrescentamos espaços depois do marcador.
        marcador_esq = "❌ G" in esquerda
        espacos = "     " if marcador_esq else "            "
        linhas.append(esquerda + espacos + direita)
