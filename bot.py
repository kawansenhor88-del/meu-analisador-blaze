...
def _relatorio_registrar(modo, resultado, gale, limite):
    ...
    del bloco[:alvo]
    try:
        # O espaçamento fica DENTRO do próprio balão do relatório.
        # U+2800 mantém a altura das 3 linhas sem criar mensagens invisíveis separadas
        # (assim não aparece visualização/horário/seta em um balão vazio).
        texto_relatorio = _relatorio_gerar(cfg, usar) + "\n⠀\n⠀\n⠀"
