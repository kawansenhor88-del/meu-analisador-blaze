...
def _preencher_visual_surfe(texto, largura_alvo):
    """Completa uma linha até a largura visual alvo usando a mesma régua do SURF após o branco."""
...
# IMPORTANTE:
# Não existe mais ajuste global para 1000+ nem para 1008+.
# Esses dois ajustes aproximavam a coluna SURF ⚫ da coluna SURF 🔴
# e alteravam um espaçamento que já estava aprovado.
#
# Mantemos SOMENTE a regra matemática já aprovada para as faixas 00–07
# de cada centena/milhar (1000–1007, 1100–1107, 1200–1207...).
# Ela é tratada em _montar_linhas_estrategia_surfe(), acima.
...
def _montar_surfe_duas_colunas(registros, numero_final_analise=None):
    """Monta as duas colunas usando a mesma matemática de alinhamento do SURF após o branco."""
    ...
    # MESMA LÓGICA DO SURF APÓS O BRANCO:
    # a posição da coluna direita depende da largura VISUAL real da primeira coluna,
    # e não de empurrões manuais para 1000/1008/1100 etc.
    ...
    for esquerda, direita in zip(vermelho, preto):
        ...
        # Mesmo separador fixo usado no SURF após o branco.
