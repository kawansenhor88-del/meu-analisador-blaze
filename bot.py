...
def adicionar_rodada(payload):
    ...
    # Só marca a rodada como processada depois que o banco confirmar.
    # Se o PostgreSQL falhar, o ID não é avançado e a rodada pode ser tentada novamente.
    foi_salva = salvar_rodada_banco(rodada, rodada_id)
    if not foi_salva:
        print("❌ RODADA NÃO CONFIRMADA NO BANCO — não marcando como processada.")
        return False
    ...
    print("========================================")
    print("✅ NOVA RODADA DOUBLE RECEBIDA E CONFIRMADA")
    print(rodada)
    print("ID:", rodada_id)
