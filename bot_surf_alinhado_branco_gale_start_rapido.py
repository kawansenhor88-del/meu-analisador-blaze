...
def _estatisticas_surfe(caminho):
    ...
    for rodada in caminho:
        ...
        for nome, jogaria in (("Preto", jogaria_preto), ("Vermelho", jogaria_vermelho)):
            # Branco não interrompe nem reinicia, mas agora conta como Gale.
            if saiu == "Branco":
                stats[nome]["erros"] += 1
                gale[nome] += 1
...
def _montar_linhas_estrategia_surfe(registros, estrategia):
    """Monta uma estratégia por vez com as colunas do SURF padronizadas."""
    ...
    for item in registros:
        ...
        # Mantém número, resultado real, cor jogada e sinal nas mesmas colunas.
        linha_resultado = (
...
def surfe_branco_callback(call):
    try:
        ...
        explicacao = "\n".join([
            ...
            "nem reiniciam o caminho, mas contam como Gale.",
            "A análise continua normalmente até completar as 50 rodadas.",
            "",
            "━━━━━━━━━━━━━━━━━━",
