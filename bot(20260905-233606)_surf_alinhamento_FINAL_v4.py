...
def _largura_visual_surfe(texto):
    """Calcula uma largura estável para o alinhamento do SURF."""
    largura = 0
...
def _montar_linhas_estrategia_surfe(registros, estrategia):
    ...
    for item in registros:
        ...
        # Um único espaço de controle para números de 1 dígito.
        espaco_rodada = "\u2007" if numero < 10 else ""
        ...
        # Mantém o marcador exatamente no mesmo ponto em todas as linhas.
        # Assim, a diferença de 1/2 dígitos não desloca o X ou o check.
        prefixo = _preencher_coluna_surfe(prefixo, 15)
        linha = f"{prefixo}{marcador}"
        linhas.append(linha)
...
def _montar_surfe_duas_colunas(registros):
    """Monta as duas colunas do SURF com espaçamento controlado."""
    ...
    for esquerda, direita in zip(vermelho, preto):
        # Após o Gale: 2 espaços de controle. Após ❌/✅: 4.
