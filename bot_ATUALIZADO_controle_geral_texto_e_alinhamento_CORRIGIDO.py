...
def _controle_geral_surfe_enviar_distribuicao(chat_id, caminho_nome):
    ...
    for gale in gales_ordenados:
        ...
        bruto_txt = (ESPACO_NUMERICO * (largura_bruto - len(bruto_str))) + bruto_str
...
def _controle_geral_surfe_enviar_sequencias(chat_id, caminho_nome):
    ...
    for gale in gales:
        ...
        bruto = (ESPACO_NUMERICO * (largura_bruto - len(bruto_str))) + bruto_str
        unico = (ESPACO_NUMERICO * (largura_unico - len(unico_str))) + unico_str
