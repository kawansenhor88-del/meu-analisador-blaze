...
def _montar_linhas_estrategia_surfe(registros, estrategia):
    ...
    for item in registros:
        ...
        # SOMENTE 01 a 08 mantêm o ajuste fino, mas agora depois do número real.
        # Assim o vão entre "01/02/..." e a primeira bolinha não fica maior.
        ajuste_01_08 = ""
        if 1 <= numero <= 8:
        ...
        espaco_cor = ("\u2007" if len(numero_real) == 1 else "") + ajuste_01_08
