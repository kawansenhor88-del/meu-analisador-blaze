    ...
    try:
        ...
        if len(analise["registros"]) < quantidade:
            ...
            mensagem = "\n".join([
                ...
                "",
                f"⚪ A partir do Branco selecionado existem apenas {disponiveis_texto} rodadas mais recentes disponíveis para análise.",
                "",
                f"📊 Você solicitou a análise de {quantidade_texto} rodadas, mas ainda não existem {quantidade_texto} rodadas após esse Branco.",
                "",
                f"💡 Você pode escolher uma quantidade menor ou analisar agora todas as {disponiveis_texto} rodadas disponíveis.",
                "",
                "👇 Clique no botão abaixo para continuar a análise com as rodadas disponíveis.",
            ])
