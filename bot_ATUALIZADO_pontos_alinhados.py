...
def _controle_geral_surfe_enviar_sequencias(chat_id, caminho_nome):
    ...
    for gale in gales:
        ...
        # O número começa imediatamente após o emoji.
        # A compensação de largura fica DEPOIS do número.
        bruto = bruto_str + (ESPACO_NUMERICO * (largura_bruto - len(bruto_str)))

        # Número colado ao 🧬; compensação somente DEPOIS do número.
        # Espaço normal mantém o separador • visualmente uniforme no Telegram.
        unico = unico_str + (" " * (largura_unico - len(unico_str)))
